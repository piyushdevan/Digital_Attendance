...
# SAMPLE_IMAGE_PATH = "C:/Users/PIYUSH KUMAR/Desktop/VIT-Digital-Attendance-System/Flask/photos/2115085.jpg"
...
def islive(image):
    ...
    label, value = test(image, args.model_dir, args.device_id)
    return label, value
